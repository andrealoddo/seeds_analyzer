...
public class Seeds_Analysis implements PlugIn {
  ...
  *richiamo della funzione originale e aggiunta delle nuove misure*/
  protected void saveResults(ImageStatistics stats, Roi roi) {
    ...
    double[] centroid = getCentroid(roi, stats);
  ...
  * purtroppo essi sono disordinati*/
  ...
  /* Metodi Andre */
  private double[] getCentroid(Roi roi, ImageStatistics stats){
    double[] centroid = new double[2]; // x, y
    centroid =  roi.getContourCentroid();
    centroid[0] /=  roi.getFloatWidth();
    centroid[1] /=  roi.getFloatHeight();
